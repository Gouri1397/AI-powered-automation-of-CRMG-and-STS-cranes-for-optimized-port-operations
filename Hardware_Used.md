...
Overview
The prototype was developed using a combination of embedded controllers, vision systems, motor drivers, actuators, and power electronics to simulate the operation of an automated Ship-to-Shore (STS) crane.
The hardware architecture was designed to support real-time container tracking, autonomous crane movement, and reliable communication between software and mechanical subsystems.
...
Input Devices
Three-Axis Joystick - Used during the manual control phase of the project.
Functions:
─ Gantry control
─ Trolley control
─ Hoist control
